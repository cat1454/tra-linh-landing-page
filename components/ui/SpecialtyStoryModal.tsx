...
export function SpecialtyStoryModal({ isOpen, onClose, specialty }: SpecialtyStoryModalProps) {
  ...
  return (
    ...
    >
      <motion.div
        ref={panelRef}
        className="relative w-full max-w-2xl overflow-hidden rounded-[2rem] bg-[#EEF1E9] text-[#10251A] shadow-[0_24px_80px_rgba(0,0,0,0.4)]"
      ...
      >
        {/* Top media banner */}
        <div className="relative aspect-[16/10] w-full bg-[#D8DDCF]">
          <Image
