            ...
            <ScrollReveal direction="up" delay={1.0}>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <Link
                  ...
                  className="group inline-flex min-h-12 items-center justify-center gap-3 rounded-full border border-[#EEF1E9]/35 bg-[#07100C]/20 px-6 py-3 text-sm font-semibold text-[#EEF1E9] backdrop-blur-sm transition-colors hover:border-[#D5A84E] hover:text-[#D5A84E] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#EEF1E9]"
                >
