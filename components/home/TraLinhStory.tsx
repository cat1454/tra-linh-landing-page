  ...
  return (
    <section id="cau-chuyen" aria-labelledby="story-heading" className="bg-[#EEF1E9] px-5 py-12 text-[#10251A] sm:px-8 sm:py-16 lg:px-16 lg:py-20 xl:px-20">
      <div className="mx-auto max-w-[1380px]">
        ...
        <div className="mt-8 grid items-start gap-8 lg:mt-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:items-start sm:gap-8">
              ...
              {secondary ? (
                <MediaFrame
                  ...
                  className="aspect-[4/5] rounded-[1.75rem] shadow-[0_30px_80px_rgba(16,37,26,0.16)] sm:mt-12 sm:aspect-[5/6]"
                  sizes="(min-width: 1024px) 27vw, 50vw"
          ...
          <ScrollReveal direction="right" duration={0.8} delay={0.15}>
            <div>
              <div className="border-l border-[#D5A84E]/65 pl-6 sm:pl-8">
                    ...
                    <ScrollReveal key={chapter.id} direction="up" delay={0.1 * index}>
                      <article className="border-t border-[#10251A]/15 pt-5">
                        ...
                        <h3 className="mt-2 font-serif text-2xl">
                          <SemanticHeadingText text={chapter.title} compact />
                        </h3>
