  ...
  return (
    <section id="cam-nang" aria-labelledby="guide-heading" className="bg-[#EEE3CB] px-5 py-12 text-[#10251A] sm:px-8 sm:py-16 lg:px-16 lg:py-20 xl:px-20">
      <div className="mx-auto max-w-[1380px]">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-10">
          <div className="relative min-h-72 overflow-hidden rounded-[1.5rem] bg-[#29452C] p-7 text-[#EEF1E9]">
            ...
            <p className="relative mt-8 max-w-sm font-serif text-3xl leading-tight">
              <SemanticHeadingText text="Trà Linh · vùng Ngọc Linh" compact />
            </p>
