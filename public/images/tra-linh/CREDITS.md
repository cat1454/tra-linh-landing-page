...
| `hat-lua-moi.jpg` | `http://dulichtralinh.vn/le-hoi/dong-bao-xo-dang-to-chuc-le-an-mung-lua-moi-323563` | Cổng thông tin du lịch Trà Linh (dữ liệu lưu trữ) | `client_confirmed` |
| `ca-nien-nuong.webp` | `http://dulichtralinh.vn/am-thuc/dac-san-ca-nien-tra-linh-324318` | Cổng thông tin du lịch Trà Linh (dữ liệu lưu trữ) | `client_confirmed` |
| `mang-rung.webp` | `http://dulichtralinh.vn/am-thuc/mang-chua-rung-324317` | Cổng thông tin du lịch Trà Linh (dữ liệu lưu trữ) | `client_confirmed` |
| `ga-nuong.webp` | `http://dulichtralinh.vn/am-thuc/ga-nuong-tra-linh-324312` | Cổng thông tin du lịch Trà Linh (dữ liệu lưu trữ) | `client_confirmed` |
